...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String TWITTER_KEY = "UYedthi1d24tuaTPkKRLKruAG";
    private static final String TWITTER_SECRET = "krwWioMqQeTl3EScJyJI66sm1Y8XYccjSj62fuOU3HoWze3ka4";
